...
<head>
	...
	function tutup(){
		...
		self.parent.$('#divList').load('<?=BASE_URL?>script/php/list_pelaksanaan_konstruksi.php?sektor='+ sektor);
...
if(!empty($_GET['id']) || $_GET['id'] != ''){
	$sql = "select indikator, bobot, is_active from p_pelaksanaan_konstruksi
			where kd_pelaksanaan = ".$_GET['id'];
...
<input type="hidden" id="action" name="action" value="add_pelaksanaan_konstruksi">
        ...
        <div class="col-md-6 col-md-offset-4 col-center">
            <div class="panel panel-info" style="margin-bottom: 0px;">
                <div class="panel-heading">
                  <b class="panel-title">Tambah Indikator Pelaksanaan Kosntruksi</b>
                </div>
