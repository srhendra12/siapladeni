    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
        	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
				...
				<tbody>
                <?php
				$where = ($_SESSION['access'] == 1) ? "and b.kd_wilayah = ".$_SESSION['wilayah'] : "";
				$sql = "select a.kabupatenkotaid, a.kabupatenkotaname, b.provinsiname, a.alamat, a.email, a.nama_kepala, a.no_telp_kepala from kabupatenkota a, provinsi b where a.r_provinsiid = b.provinsiid ".$where." order by a.kabupatenkotaid";
