...
<table border="0" cellspacing="3" cellpadding="4">
    <tr>
        <td>
            <div align="center"><b>HASIL PENGINPUTAN INSTRUMEN<br>DETEKSI DINI POTENSI GANGGUAN KEAMANAN DAN KETERTIBAN 
...
<table class="table table-hover table-condensed">
    <tbody>
        <tr>
            <td width="20%"><label class="control-label" for="thnKegiatan">Periode</label></td>
...
$pdf->SetMargins(20, 12, 10, true);
$pdf->AddPage('L', 'Letter');

$html ='
<h4>INSTRUMENT DETEKSI DINI POTENSI GANGGUAN KEAMANAN DAN KETERTIBAN</h4>
<table border="1" cellspacing="1" cellpadding="4">
    <tr align="center">
        <th width="30"><b>No</b></th>
        <th width="180"><b>Elemen Assessment</b></th>
        <th width="275"><b>Parameter</b></th>
    ...
    while($row = mysqli_fetch_array($exe, MYSQLI_ASSOC)){
        ...
        $html .= '<tr valign="middle" class="bgGrey">'; 
            ...
            $html .= '<td colspan="6"><b>'.strtoupper($row['indikator']).'</b></td>';
        $html .= '</tr>';
                        ...
                        if($numRows > 0){
                           $html .= '<table border="0" cellspacing="1" cellpadding="4">';
                              $html .= '<tr style="background-color:#dedede;">';
                                 $html .= '<td width="35">No.</td>';
                                 $html .= '<td width="188">Deskripsi</td>';
                                 $html .= '<td align="center" width="42">Nilai</td>';
                              $html .= '</tr>';
                           $j=0;
                           while($param = mysqli_fetch_array($run, MYSQLI_ASSOC)){
                              ...
                              $html .= '<tr style="border-bottom:1px solid #000;">';
                                 ...
                                 $html .= '<td '.$color.'>'.$param['nm_parameter'].'</td>';
    ...
    $html .= '</tbody>
    <tr class="bgGrey">
        <td colspan="3" align="left"><b>JUMLAH TOTAL</b></td>
        <td align="center">
    ...
    <tr class="bgGrey">
        <td colspan="3" align="left"><b>PERSENTASE NILAI DIPEROLEH</b></td>
        <td align="center">&nbsp;</td>
...
$pdf->Output('INPUT_EVALUASI_DETEKSI_DINI_POTENSI_GANGGUAN_KEAMANAN_DAN_KETERTIBAN_'.strtoupper($nmKota).'_WILAYAH '.strtoupper($nmPropinsi).'_PERIODE_DATA_'.strtoupper(getBulan($bulan_data))."_".$tahun_data.'.pdf', 'I');