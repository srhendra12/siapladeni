...
$(document).ready(function() {
        ...
        buttons         : [
         {
            ...
            title: 'Laporan Penilaian Deteksi Dini Potensi Gangguan Keamanan dan Ketertiban Periode <?php echo !empty($_GET['tahunData']) ? $_GET['tahunData'] : date('Ym')?>'
         },
         {   
            extend      : 'pdfHtml5',
    ...
    $("#example1").on("click", ".printHasil", function(){
        var keyNumber = $(this).attr('id');
        window.open('<?=BASE_URL?>script/php/printDokPerencanaan.php?keyNumber='+ keyNumber, '_blank');
    });

    $("#example1").on("click", ".printInstrument", function(){
        var keyNumber = $(this).attr('id');
        window.open('<?=BASE_URL?>script/php/printInstrumentPerencanaan.php?keyNumber='+ keyNumber, '_blank');
    });
});
</script>
            ...
            <table id="example1" class="table table-striped table-bordered" cellpadding="0" cellspacing="0" width="100%" >
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="isCenter" width="7%">Periode<br>Kegiatan</th>
                        ...
                        <th rowspan="2" class="isCenter">Cetak Hasil<br>Penilaian</th>
                        <th rowspan="2" class="isCenter">Cetak Input<br>Instrument</th>
                    </tr>
                    <tr>
                ...
                while($row = mysqli_fetch_array($exe, MYSQLI_ASSOC)){
                    ...
                    echo '<tr valign="middle" id="'.$row['kd_perencanaan_umum'].'" style="cursor:pointer;">';  
                        ...
                        echo '<td align="center">';
                            if($row['is_verify'] == '1'){
                                echo '<span class="glyphicon glyphicon-print fa-2x printHasil" id="'.$row['keyNumber'].'"></span>';
                            }
                            else{
                                echo "-";
                            }
                        ...
                        echo '<td align="center">';
                            if($row['is_verify'] == '1'){
                                echo '<span class="glyphicon glyphicon-print fa-2x printInstrument" id="'.$row['keyNumber'].'"></span>';
                            }
                            else{
                                echo "-";
                            }
