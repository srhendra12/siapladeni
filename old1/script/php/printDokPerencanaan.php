...
<table border="0" cellspacing="3" cellpadding="4">
    <tr>
        <td>
            <div align="center"><b>HASIL EVALUASI<br>DETEKSI DINI POTENSI GANGGUAN KEAMANAN DAN KETERTIBAN 
            <br>'.strtoupper($nmKota).'<br>WILAYAH '.strtoupper($nmPropinsi).'<br>PERIODE DATA '.strtoupper(getBulan($bulan_data))." ".$tahun_data.'</b>
            </div>
        </td>
    </tr>
</table><br><br>';
...
$html ='
<h4>INSTRUMENT EVALUASI PENGURANGAN RESIKO  GANGGUAN KEAMANAN</h4>
