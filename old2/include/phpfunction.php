...
function login($form_ID, $form_password){
	...
	if($form_password == "" or $form_ID == ""){
		...
		$sql = "select kd_user, userid, username, kd_access, kd_propinsi, kd_kota, is_active
...
// 	// Relevansi 1.1
// 	if($nilaiRelevansi == 1){ 
// 		$hasilEvaluasi = $textEvaluasi1;
// 	}
// 	// Relevansi 1.2
// 	else if($nilaiRelevansi == 2){
...
// 		}
// 		// Efisiensi 1.2
// 		else if($nilaiEfisiensi == 2){
			
// 			// Efektifitas 1.1
// 			if($nilaiEfektifitas == 1){
// 				$hasilEvaluasi = $textEvaluasi1;
// 			}
// 			// Efektifitas 1.2
// 			else if($nilaiEfektifitas == 2){
...
// 				}
// 				// Dampak 1.2
// 				else if($nilaiDampak == 2){

// 					// Berkelanjutan 1.1
// 					if($nilaiBerkelanjutan == 1){
// 						$hasilEvaluasi = $textEvaluasi1;
// 					}
// 					// Berkelanjutan 1.2
// 					else if($nilaiBerkelanjutan == 2){
// 						$hasilEvaluasi = $textEvaluasi1;
// 					}
// 					// Berkelanjutan 1.3
// 					else if($nilaiBerkelanjutan == 3){
// 						$hasilEvaluasi = $textEvaluasi2;
// 					}
// 				}
// 				// Dampak 1.3
// 				else if($nilaiDampak == 3){
