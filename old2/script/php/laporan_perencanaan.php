            ...
            <table id="example1" class="table table-striped table-bordered" cellpadding="0" cellspacing="0" width="100%" >
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="isCenter">Cetak Dokumen</th>
                    </tr>
                    <tr>
                ...
                while($row = mysqli_fetch_array($exe, MYSQLI_ASSOC)){
                    ...
                    echo '<tr valign="middle" id="'.$row['kd_perencanaan_umum'].'" style="cursor:pointer;">';  
                        ...
                        echo '<td align="center">';
                            if($row['is_verify'] == '1'){
                                echo '<span class="glyphicon glyphicon-print fa-2x print" id="'.$row['keyNumber'].'"></span>';
                                // echo '<span class="glyphicon glyphicon-print fa-2x print" id="'.$row['kd_perencanaan_umum'].'"></span>';
                            }
                            else{
                                echo "-";
                            }
