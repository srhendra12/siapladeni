...
<body>
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                if(isset($_SESSION['token']) || $_SESSION['token'] != ''){
                                    switch($_SESSION['access']){
                                        case 1 : include 'include/menu/menu_admin.php'; break;
                                ...
                                if(empty($_SESSION['userid']) || !isset($_SESSION['userid'])){
                                    ...
                                    echo '<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Hi, <b>'.strtoupper($_SESSION['username']).'</b> <span class="caret"></span></a>';
                                        echo '<ul class="dropdown-menu">';
                                            echo '<li><a href="#signout" style="margin-top:-5px !important;" id="signout"><b>Sign Out</b></a></li>';
                                        echo '</ul>';
                                    echo '</li>';   
                                }
                                ?>
    ...
    $(document).ready(function(){
        ...
        // ajaxloading('divHasilPemantauan');
        // $('#divHasilPemantauan').load('<?=BASE_URL?>script/php/laporan_pascaKonstruksi.php?isDashboard=yes');

        // ajaxloading('divRekapMonev');
        // $('#divRekapMonev').load('<?=BASE_URL?>script/html/rekapHasilMonev.html');
